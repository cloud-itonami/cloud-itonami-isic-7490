...
`cloud-itonami-isic-7490` accepts contributions to the OSS blueprint, capability
...
- Keep issuing a deliverable or attestation to a client behind the Professional Services Governor.
