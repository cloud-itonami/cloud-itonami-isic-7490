# Operator Quickstart — Other professional, scientific and technical activities n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 7490** (`cloud-itonami-isic-7490`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7490.git
cd cloud-itonami-isic-7490
```
...
- Blueprint governor key: `professional-services-governor`
- Likely source path: `proserv.governor.cljc`
